...
import CableComponent from '../Components/CableComponent'
...
const Cable = () => {
  ...
  return (
    <div>
      ...
      {vendors && <CableComponent data={vendors} isLoading={isLoading} Error={error} ser={service_id} />}
    </div>
  )
}
